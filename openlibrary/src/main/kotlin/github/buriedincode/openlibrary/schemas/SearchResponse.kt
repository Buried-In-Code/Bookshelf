...
data class SearchResponse<T>(
  ...
  data class Author(
    ...
    @JsonNames("birth_date") @Serializable(with = LocalDateSerializer::class) val dateOfBirth: LocalDate? = null,
    val date: String? = null,
    @JsonNames("death_date") @Serializable(with = LocalDateSerializer::class) val dateOfDeath: LocalDate? = null,
    val key: String,
    val name: String,
  ...
  data class Work(
    ...
    @JsonNames("cover_i") val cover: Long? = null,
    ...
    @JsonNames("ia_collection_s") val iaCollectionString: String? = null,
    val iaLoadedId: List<String> = emptyList(),
    val idAmazon: List<String> = emptyList(),
    val idBetterWorldBooks: List<String> = emptyList(),
    @JsonNames("id_depósito_legal") val idDepositoLegal: List<String> = emptyList(),
    ...
    @JsonNames("lending_edition_s") val lendingEdition: String? = null,
    @JsonNames("lending_identifier_s") val lendingIdentifier: String? = null,
    ...
    @JsonNames("printdisabled_s") val printDisabled: String? = null,
    @JsonNames("public_scan_b") val publicScan: Boolean,
    ...
    @JsonNames("ratings_count_1") val oneStarRatings: Int? = null,
    @JsonNames("ratings_count_2") val twoStarRatings: Int? = null,
    @JsonNames("ratings_count_3") val threeStarRatings: Int? = null,
    @JsonNames("ratings_count_4") val fourStarRatings: Int? = null,
    @JsonNames("ratings_count_5") val fiveStarRatings: Int? = null,
